...
line = LINE("Eu93hAOzEjVUNTsFYJt9.NprHq8eb+2yjNxRq5sA0Aq.4aT3MA3sFH3AT9J0f0sAR1Kvk7ombv7JaUG6U/sDJCY=")
#======================ONENG==============================#
kiker1 = LINE("EuE3zuSnOZVX0X2Sxl9e.9DHEJ/prxkPgAOndIP3x+G.VPqn/jJPRtg1dRcKNnp8kt5QohmSSXjC7T+JX9dQ5cE=")
#======================KIKER1===============================#
kiker2 = LINE("EuQNSJZcutyyIYi86Ms7.SzaB0pBN4pwFDys+Jcn0HW.XJNzLgkmVT1rWipV+yq3zrFSWwDCMr5rGJ2ZLrFaJ8Y=")
#======================KIKER2================================#
...
#======================================================
assist = [line,kiker1,kiker2]
admin = ["u9cf46143c101ff66099d7ad0e526b469"]
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 0:
                msg.to = msg._from
                if msg._from == "u9cf46143c101ff66099d7ad0e526b469":
                    if "join:" in msg.text:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendContact(to, "u9cf46143c101ff66099d7ad0e526b469")
